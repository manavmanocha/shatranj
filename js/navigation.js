var site_url = '';
var nav  = [ '#PlayChess', '#LearnChess', '#Members', '#AboutUs', '#ContactUs' ];
						...
						$(this)
							.children()
								.animate( {backgroundPosition:'(0px -45px)'},"fast",function(){
											...
											$(parent).css({backgroundImage: 'url(img/nav1.png)'});
									});
					});
			break;
		}
...
function mMouseOver(e)
{
	...
	$(this)
		...
		.css({backgroundImage: 'url(img/nav1.png)',cursor: 'pointer'})
...
{			
	...
	$(this)
		...
		.css({backgroundImage: 'url(img/nav1.png)', cursor: ''});
}
