...
$('#answer_1_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
...
$('#answer_2_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
...
$('#answer_3_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
...
$('#answer_4_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
...
$('#answer_5_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
...
$('#answer_6_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
...
$('#answer_7_text').highlightFade({color:'rgb(50, 24, 24)', speed: 500});
} });
});
